...
public class CarouselView extends CarouselSpinner implements GestureDetector.OnGestureListener {
    ...
    /**
     * 描述：TODO
     * @see com.zeroapp.action.view.carousel.CarouselAdapter#selectionChanged()
     * @author: zhaoqp
     * @date：2013-11-28 上午11:14:35
     * @version v1.0
     */
    ...
    /**
     * 描述：TODO
     * @see com.zeroapp.action.view.carousel.CarouselAdapter#setSelectedPositionInt(int)
     * @author: zhaoqp
     * @date：2013-11-28 上午11:14:35
     * @version v1.0
     */
...
//                }
    ...
    private void Calculate3DPosition(CarouselItemView child, int diameter, float angleOffset){
        ...
        float x = -(float) (diameter / 2 * android.util.FloatMath.sin(angleOffset)) + diameter
                / 2
                - child.getWidth() / 2;
